...
| ... | _(Bổ sung đến 50 trong quá trình triển khai)_ | ...       | ...          | ...                  |
...
## Phụ lục D – Thống kê thực tế sau Sprint 1 (08/03/2026)

> Dữ liệu được trích xuất trực tiếp từ hệ thống sau đợt chạy Autopilot đầu tiên.

### Thống kê Ngành học thực tế

- **Tổng số ngành trong DB:** 605
- **Ngành chuẩn (Seed):** 215
- **Ngành phát sinh (Auto-discovered):** 388
- **Tỷ lệ ngành chưa có Holland Type:** 64.5% (Cần xử lý trong Sprint 2)

### Danh sách các Mã ngành AUTO cần rà soát (Mẫu)

| Mã AUTO  | Tên ngành thô                      | Tần suất xuất hiện |
| :------- | :--------------------------------- | :----------------- |
| AUTO-001 | Kỹ thuật phần mềm (Chất lượng cao) | Cao                |
| AUTO-002 | Công nghệ thông tin (Tiếng Anh)    | Trung bình         |
| AUTO-003 | Kinh doanh quốc tế (Liên kết)      | Thấp               |

---

_Phụ lục thuộc về tài liệu: [README – Kế hoạch Thu thập Dữ liệu](./README.md)_
